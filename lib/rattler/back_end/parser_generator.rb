...
module Rattler::BackEnd
  ...
  module ParserGenerator
    ...
    autoload :SemanticActionGenerator, 'rattler/back_end/parser_generator/semantic_action_generator'
    autoload :NodeActionGenerator, 'rattler/back_end/parser_generator/node_action_generator'
    ...
    autoload :SequenceGenerating, 'rattler/back_end/parser_generator/sequence_generating'
